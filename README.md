...
[Quickstart](#quickstart) | [Mental model](#the-mental-model) | [AI coding agents](https://simcord.readthedocs.io/en/latest/guides/ai-coding-agents/) | [Documentation](https://simcord.readthedocs.io/) | [Parity matrix](https://simcord.readthedocs.io/en/latest/parity-matrix/) | [Contributing](CONTRIBUTING.md)
...
SimCord runs discord.py's real machinery, including its parsers, cache, command frameworks and
views, against an in-memory model of Discord's REST API and gateway. Your bot code runs
unmodified and can't tell the difference.
...
The [AI coding agent guide](https://simcord.readthedocs.io/en/latest/guides/ai-coding-agents/)
includes a project-instructions block, a complete workflow, and the mistakes agents should avoid.
...
- **Actors wait for the bot to finish reacting.** Each verb settles the loop, running
  callbacks and draining `asyncio.sleep` chains before returning, so the reply is already there
...
| 🧠 [Core concepts](https://simcord.readthedocs.io/en/latest/concepts/) | Builders, actors, and queries: the mental model. |
| [AI coding agents](https://simcord.readthedocs.io/en/latest/guides/ai-coding-agents/) | Reliable discord.py implementation and test workflow for coding agents. |
...
[MIT](LICENSE). Unofficial and not affiliated with Discord Inc. or the discord.py project.
