...
The pytest extra installs pytest and pytest-asyncio. SimCord requires Python 3.11 or newer and discord.py 2.7.1 or newer; it is tested on Python 3.11–3.14.
