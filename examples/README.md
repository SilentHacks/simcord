...
- **`test_bot.py`** — one test per feature, each in the builders → actors →
...
For more patterns — selects, autocomplete, view timeouts, fault injection, DMs
and more — see the [recipe cookbook](../docs/cookbook.md) and the
